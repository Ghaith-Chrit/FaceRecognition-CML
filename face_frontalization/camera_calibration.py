...
# Code was slightly modified to work with python3 and cv2 from
# https://github.com/dougsouza/face-frontalization which is written by Douglas Souza
# Check "FaceRecog\SIFT_FaceNorm.ipynb" for an example
